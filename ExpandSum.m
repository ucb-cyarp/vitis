...
for i = 1:length(busWidth)
    ...
    out_wire_arc.prependIntermediateNodeEntry(constBlock, 1, i, 'Standard', 'Out'); %Since we are expanding a sum, the output port of the origional block would be 'standard' and the direction is 'out'
