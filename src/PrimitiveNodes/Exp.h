...
class Exp : public PrimitiveNode {
    friend NodeFactory;
...
private:
    ...
    /**
     * @brief Construct a Exp node, with a given parent.
     *
     * @note To construct from outside of hierarchy, use factories in @ref NodeFactory
     *
     * @param parent parent node
     */
    explicit Exp(std::shared_ptr<SubSystem> parent);
     ...
     */
    Exp(std::shared_ptr<SubSystem> parent, Exp* orig);
...
public:
     ...
     */
    static std::shared_ptr<Exp> createFromGraphML(int id, std::string name,
