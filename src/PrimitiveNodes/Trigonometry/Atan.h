...
class Atan : public PrimitiveNode {
    friend NodeFactory;
...
private:
    ...
    //==== Constructors ====
    /**
     * @brief Construct an Atan node
     */
    Atan();

    /**
     * @brief Construct an Atan node, with a given parent.
     *
     * @note To construct from outside of hierarchy, use factories in @ref NodeFactory
     *
     * @param parent parent node
     */
    explicit Atan(std::shared_ptr<SubSystem> parent);
     ...
     */
    Atan(std::shared_ptr<SubSystem> parent, Atan* orig);

public:
    //==== Factories ====
    /**
     * @brief Creates an Atan node from a GraphML Description
     *
     ...
     */
    static std::shared_ptr<Atan> createFromGraphML(int id, std::string name,
