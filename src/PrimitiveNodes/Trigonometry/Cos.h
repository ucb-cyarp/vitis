...
class Cos : public PrimitiveNode {
    friend NodeFactory;
...
private:
    ...
    //==== Constructors ====
    /**
     * @brief Construct a Cos node
     */
    Cos();

    /**
     * @brief Construct a Cos node, with a given parent.
     *
     * @note To construct from outside of hierarchy, use factories in @ref NodeFactory
     *
     * @param parent parent node
     */
    explicit Cos(std::shared_ptr<SubSystem> parent);
     ...
     */
    Cos(std::shared_ptr<SubSystem> parent, Cos* orig);

public:
    //==== Factories ====
    /**
     * @brief Creates a Cos node from a GraphML Description
     *
     ...
     */
    static std::shared_ptr<Cos> createFromGraphML(int id, std::string name,
