...
private:
    ...
    //==== Constructors ====
    /**
     * @brief Construct a Ln node
     */
    Ln();

    /**
     * @brief Construct a Ln node, with a given parent.
     *
     * @note To construct from outside of hierarchy, use factories in @ref NodeFactory
     *
     * @param parent parent node
     */
    explicit Ln(std::shared_ptr<SubSystem> parent);
     ...
     */
    Ln(std::shared_ptr<SubSystem> parent, Ln* orig);

public:
    //==== Factories ====
    /**
     * @brief Creates a Ln node from a GraphML Description
     *
     ...
     */
    static std::shared_ptr<Ln> createFromGraphML(int id, std::string name,
